...
import websitesTranslations from '../pages/cms/websites/i18n'
import questionsTranslations from '../pages/cms/questions/i18n'
import articlesTranslations from '../pages/cms/articles/i18n'
import imagesTranslations from '../pages/cms/images/i18n'
import audiosTranslations from '../pages/cms/audios/i18n'
import videosTranslations from '../pages/cms/videos/i18n'
import filesTranslations from '../pages/cms/files/i18n'

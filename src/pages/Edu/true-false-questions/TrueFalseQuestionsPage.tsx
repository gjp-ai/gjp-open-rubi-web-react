...
export const EduTrueFalseQuestionsPage = () => {
  const kind = 'true-false-questions' as EduQuestionKind
  ...
  const pageLabel = t('nav.edu_true_false')
      ...
      {loading ? (
        ...
        <div className="tfq-grid">
          {displayItems.map((question) => (
            <TrueFalseQuestionCard key={question.id} question={question} isExpandedView={isExpandedView} />
          ))}
        </div>
      )}
...
export default EduTrueFalseQuestionsPage
